...
#
# Datastructure format is __ASCII text__________________
...
wget http://fortunecookieapi.herokuapp.com/v1/fortunes
F=$( cat /home/courseuser/tmp/ftellerxTM/fortunes )
FTTEMPDIR="$FTTEMPDIR $F" 
...
dumpfile /home/courseuser/tmp/ftellerxTM/fortunes
cat $FILENAME
...
curl -s -L http://fortunecookieapi.herokuapp.com/v1/fortunes | json_pp
touch fortunes_pp
#copied the pretty printed text into a new file named fortunes_pp.
...
dumpfile /home/courseuser/tmp/ftellerxTM/fortunes_pp
cat $FILENAME
...
#<YOUR CODE HERE>
sed -n '/"message"/p' /home/courseuser/tmp/ftellerxTM/fortunes_pp > /home/courseuser/tmp/ftellerxTM/fortunes_messages
...
wc -l /home/courseuser/tmp/ftellerxTM/fortunes_messages
export NUMMSG=100
...
export CHOSEN=$"echo $(( $RANDOM % 100 + 1 )) | bc"
